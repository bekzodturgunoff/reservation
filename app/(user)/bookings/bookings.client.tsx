...
export function UserBookingsClient({ user, initialBookings }: { user: User; initialBookings: unknown[] }) {
              ...
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-xl bg-surface-subtle shrink-0 overflow-hidden">
                  {booking.venues?.photos?.[0] ? (
                    <Image src={booking.venues.photos[0]} alt="" fill className="object-cover" sizes="56px" />
                  ) : (
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-xl bg-surface-subtle shrink-0 overflow-hidden">
                {sel.venues?.photos?.[0] ? (
                  <Image src={sel.venues.photos[0]} alt="" fill className="object-cover" sizes="64px" />
                ) : (
