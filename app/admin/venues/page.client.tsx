...
interface VenueWithCategory extends Omit<Venue, 'categories'> {
  categories: { name_uz: string; name_ru: string; icon: string } | null
}

interface AdminVenuesClientProps {
  initialVenues: VenueWithCategory[]
  initialOwners: { id: string; full_name: string | null }[]
}

export default function AdminVenuesClient({ initialVenues, initialOwners }: AdminVenuesClientProps) {
