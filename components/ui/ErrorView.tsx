    ...
    <div className="min-h-[60vh] flex items-center justify-center bg-surface-subtle px-4">
      <div className="text-center max-w-md">
        ...
        <div className="flex gap-3 justify-center">
          <button onClick={reset} className="inline-flex items-center justify-center h-11 px-6 bg-brand text-white font-medium text-sm rounded-xl hover:bg-brand-dark transition-colors">
