    ...
    <div className="relative z-10 -mt-7 pb-6">
      <div className="max-w-[760px] mx-auto px-4">
        <div className="bg-white rounded-2xl shadow-modal p-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-0">
          {/* City */}
          <div className="flex items-center gap-2 flex-1 px-4 h-14 border-b sm:border-b-0 sm:border-r border-line">
          ...
          {/* Date */}
          <div className="relative flex items-center gap-2 flex-[0.8] px-4 h-14 border-b sm:border-b-0 sm:border-r border-line">
            <button
            ...
            {dateOpen && (
              <div className="absolute top-full left-0 mt-2 z-30 bg-white rounded-2xl shadow-modal border border-line p-3">
                <DayPicker
                  mode="single"
                  selected={date}
          ...
          {/* Guests */}
          <div className="flex items-center gap-2 flex-[0.6] px-4 h-14 border-b sm:border-b-0 border-line">
